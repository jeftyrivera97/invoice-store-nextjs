...
import { createProducto, editProducto } from "@/app/actions/productos";
import { ProductoData } from "@/types/Productos";
...
export const EditProductoForm = ({ categorias, impuestos, proveedores, usuario, producto }: ProductoFormProps) => {
  ...
  return (
    <form action={editProducto}>
      {/* Hidden inputs para mantener los valores de los selects y el ID */}
      <input type="hidden" name="id" value={producto.id.toString()} />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="grid gap-2">
          ...
          <Select 
            name="id_impuesto" 
            value={formData.id_impuesto?.toString() || ""}
